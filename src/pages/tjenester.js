          ...
          <Container>
            <Link to="/nb">
              <div className="slideButton goBackHome">
                <div>Gå hjem igjen</div> <span className="rotateUp"><Arrow /></span>
              </div>
            </Link>
          </Container>
        </div>
          ...
          render={data => (
            ...
            licenseKey={'D9096ED4-77F14A81-8A5B07B2-83C84CBE'}
              ...
              anchors={data.allWordpressPost.edges
                .filter(edge => edge.node.language == "9")
                                ...
                                <div className="slideContentItem">
                                  ...
                                  <div className="proceed mobileOnly">
                                    <a href={edge.node.acf.link} target="_blank">
                                      <div className="proceedText">Fortsette</div> <Arrow />
                                    </a>
                                  </div>
                                  ...
                                  >
                                    ...
                                    >
                                      <div>Neste</div> <span className="rotateDown"><Arrow /></span>
