      ...
      <StaticQuery
        ...
        render={data => (
          ...
          <div className="mainSection">
            ...
            <Hamburger />
            <Container>
              <p>{data.allWordpressPage.edges.filter(page => page.node.wordpress_id === 82)[0].node.title}</p>
              
              <Link className="slideButton" to={data.allWordpressPage.edges.filter(page => page.node.wordpress_id === 82)[0].node.acf.link}>
                <div className="textGray">{data.allWordpressPage.edges.filter(page => page.node.wordpress_id === 82)[0].node.acf.button}</div> <Arrow /> 
              </Link>
            </Container>
